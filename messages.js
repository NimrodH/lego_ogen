...
ובהמשך יופיעו עוד שני בסיסים מאחורי אבני הבנין .  בחר האם
תרצה שהמערכת תבחר עבורך את צבעי החלקים באופן אוטומטי
אבל תתווסף לתוצאה שלך תוספת זמן של 3 דקות.  לדוגמא
אם תסיים את השלב הזה תוך 9 דקות, הזמן שייחשב לציון הסופי
יהיה 12 דקות. או שתבחר את הצבעים בעצמך, כמו בתרגול
...
.ובהמשך יופיעו עוד שני בסיסים מאחורי אבני הבנין
